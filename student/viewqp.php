...
<body>
    <main class="mainContainer">
        ...
        <div class="questionHeader">
           ...
           <h4> <p class="italicFont" align="center">Each question in section A <?php echo isset($row['part_a_mark']) ? "Mark : " . $row['part_a_mark'] : ''; ?></p></h4>
        </div>
        <div class="questions">
            <?php
        ...
        <div class="questionHeader">
            ...
            <h4 align="center"><p class="italicFont">Each question in section B <?php echo isset($row['part_b_mark']) ? "Mark : " . $row['part_b_mark'] : '';?> </p></h4>
        </div>
        <div class="questions" >
            <?php
