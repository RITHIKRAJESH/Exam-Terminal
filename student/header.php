...
<head>
    <title>EXAM TERMINAL STUDENT</title>
    <meta charset="utf-8">
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-navigation-label">SUBJECTS</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded">
                                    <a href="viewsubjects.php" class="waves-effect waves-dark">
                            ...
                            <div class="pcoded-navigation-label">Time Table</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded">
                                    <a href="viewtimetable.php" class="waves-effect waves-dark">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded">
                                    <a href="questionpaper.php" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext">Questionpaper</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
                     ...
                     <div class="pcoded-navigation-label">QuestionPaper</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded">
                                    <a href="answersheet.php" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>BC</b></span>
