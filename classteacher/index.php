...
$semester = $row1['sem'];
  $sql = "SELECT register.*, login.status FROM register JOIN login ON register.userid = login.userid  WHERE register.role = 'Student' AND sem='$semester' AND status='inactive'";
 $result=mysqli_query($conn,$sql);
 ...
 <div class="pcoded-inner-content">
        ...
        ?>
            <tr>
               ...
               <td><a href='active.php?userid=<?php echo $rows["userid"];?>'><button type="button" class="btn waves-effect waves-light btn-success">Accept</button><a href='delete.php?userid=<?php echo $rows["userid"];?>'><button type="button" class="btn waves-effect waves-light btn-danger">Delete</button></a></td>
            </tr>
