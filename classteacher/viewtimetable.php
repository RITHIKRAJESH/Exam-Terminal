...
<div class="pcoded-inner-content">
        ...
        ?>
            <tr>
               ...
               <td><a href='action.php?tid=<?php echo $rows["tid"];?>'><button type="button" class="btn waves-effect waves-light btn-success">UPLOAD</button></a></td>
               <td><a href='updatetable.php?tid=<?php echo $rows["tid"];?>'><button type="button" class="btn waves-effect waves-light btn-warning">UPDATE</button></a>
