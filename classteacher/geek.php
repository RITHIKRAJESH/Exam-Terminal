    ...
    <form action="#" method="POST">
        ...
        <div class="form-group row">
                                                            ...
                                                            <label class="col-sm-4 col-form-label">Time</label>     
                                                                    ...
                                                                    <input type="text"  name="tmark" required><br>
                                                                </div>
                                                            </div>
                                                             <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Part A</label>
                                                                 <div class="col-sm-4">
                                                                    <input type="checkbox" name="partA" value="1" required>
                                                                </div>
                                                                <div class="col-sm-4">
            ...
            <label class="col-sm-2 col-form-label">Questions</label>
            <div class="col-sm-8">
                <select name="question3" id="question3" class="form-control" required>
            ...
            <label class="col-sm-2 col-form-label">Questions</label>
            <div class="col-sm-8">
                <select name="question4" id="question4" class="form-control" required >
                    ...
                    <!-- Options will be dynamically populated using JavaScript -->
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div>
                                                              <input type="checkbox" name="partB" value="2" required>
                                                                </div>
                                                                <div class="col-sm-4">
...
<script>
    function getQuestions(subject, mark, modules) {
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "get_questions.php?subject=" + subject + "&mark=" + mark, true);
        xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200) {

            // Assign questions to the select element for Part A
            document.getElementById("question").innerHTML = xhr.responseText;
            document.getElementById("question1").innerHTML = xhr.responseText;
            document.getElementById("question2").innerHTML = xhr.responseText;
            document.getElementById("question3").innerHTML = xhr.responseText;
            document.getElementById("question4").innerHTML = xhr.responseText;
        }
    };
    xhr.send();
}

function getQuestionsSingle(subject, mark) {
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "get_questions.php?subject=" + subject + "&mark=" + mark, true);
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                document.getElementById("question5").innerHTML = xhr.responseText;
                document.getElementById("question6").innerHTML = xhr.responseText;
                document.getElementById("question7").innerHTML = xhr.responseText;
                document.getElementById("question8").innerHTML = xhr.responseText;
                document.getElementById("question9").innerHTML = xhr.responseText;
